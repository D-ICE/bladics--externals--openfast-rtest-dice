...
CHARACTER(  25), PARAMETER   :: FmtDat    = "(F8.4,99('"//Tab//"',ES10.3E2,:))" ! The format of the debugging data
...
INTEGER(4)                   :: MaxLoggingChannels                              ! Record 62: Maximum number of values which can be returned for logging (-)
REAL(4)                      :: PtfmPitch                                       ! Extra record 0: Platform pitch angle
REAL(4)                      :: PtfmRVyt                                        ! Extra record 1: Platform pitch velocity
REAL(4)                      :: PtfmRAyt                                        ! Extra record 2: Platform pitch acceleration
REAL(4)                      :: PtfmRoll                                       ! Extra record 3: Platform roll angle
REAL(4)                      :: PtfmRVxt                                        ! Extra record 4: Platform roll velocity
REAL(4)                      :: PtfmRAxt                                        ! Extra record 5: Platform roll acceleration
REAL(4)                      :: PtfmYaw                                       ! Extra record 6: Platform yaw angle
REAL(4)                      :: PtfmRVzt                                        ! Extra record 7: Platform yaw velocity
REAL(4)                      :: PtfmRAzt                                        ! Extra record 8: Platform yaw acceleration
...
Time         =       avrSWAP( 2)
   ...
   ! Save extra fields in CSV
R            = NINT( avrSwap(25) )
NumTrq       = NINT( avrSwap(26) )
MaxLoggingChannels = NINT( avrSwap(62) )
PtfmPitch    =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 0)
PtfmRVyt     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 1)
PtfmRAyt     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 2)
PtfmRoll     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 3)
PtfmRVxt     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 4)
PtfmRAxt     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 5)
PtfmYaw      =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 6)
PtfmRVzt     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 7)
PtfmRAzt     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 8)
PtfmSway     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 9)
PtfmSurge    =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 10)
PtfmHeave    =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 11)
PtfmTVyi     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 12)
PtfmTVxi     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 13)
PtfmTVzi     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 14)
PtfmTAyi     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 15)
PtfmTAxi     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 16)
PtfmTAzi     =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 17)
YawBrRDyp    =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 18)
YawBrRDxp    =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 19)
YawBrRDzp    =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 20)
YawBrRVyp    =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 21)
YawBrRVxp    =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 22)
YawBrRVzp    =       avrSWAP(R + MaxLoggingChannels + 2*NumTrq + 23)

IF ( iStatus == 0 ) THEN
   ! Start of simulation : open text file in write mode. It will be located in the execution folder.
   OPEN(UnER, FILE = 'extra_records.csv', STATUS = 'REPLACE', IOSTAT = ErrStat)
   IF ( ErrStat /= 0 ) THEN
      aviFAIL = -1
