...
PtfmPitch    =       avrSWAP(R + 2*NumTrq + 0)
PtfmRVyt     =       avrSWAP(R + 2*NumTrq + 1)
PtfmRAyt     =       avrSWAP(R + 2*NumTrq + 2)
PtfmRoll     =       avrSWAP(R + 2*NumTrq + 3)
PtfmRVxt     =       avrSWAP(R + 2*NumTrq + 4)
PtfmRAxt     =       avrSWAP(R + 2*NumTrq + 5)
PtfmYaw      =       avrSWAP(R + 2*NumTrq + 6)
PtfmRVzt     =       avrSWAP(R + 2*NumTrq + 7)
PtfmRAzt     =       avrSWAP(R + 2*NumTrq + 8)
